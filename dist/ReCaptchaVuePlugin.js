...
function VueReCaptcha(Vue, options) {
    ...
    var thenAction = function (wrapper) {
    ...
    var catchAction = function (error) {
    ...
    if (options.siteKey != null) {
        ...
        Vue.prototype.$loadCaptcha = function (siteKey) { return __awaiter(_this, void 0, void 0, function () {
            var options;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        options = Vue.prototype.$captchaOptions;
                        options.siteKey = siteKey;
                        console.log(options);
                        return [4, plugin.initializeReCaptcha(options).then(function (wrapper) {
                                thenAction(wrapper);
                            }).catch(function (error) {
                                catchAction(error);
                            })];
